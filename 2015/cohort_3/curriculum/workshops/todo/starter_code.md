...
[class^="icon-"], [class*=" icon-"] {
  ...
  width: 12px;
  height: 12px;
  background-image: url("https://cloud-n20l8ciby-hack-club-bot.vercel.app/87xOQtCqY.png");
    ...
    <div class="todo">
      ...
      <ul id="todo-list">
        <li>
          ...
          <img class="delete" src="https://cloud-n20l8ciby-hack-club-bot.vercel.app/88BtLxCD6.png">
        </li>
        <li>
          <input class="toggle" type="checkbox">
          <span>Hear no evil</span>
          <img class="delete" src="https://cloud-n20l8ciby-hack-club-bot.vercel.app/89BtLxCD6.png">
        </li>
        <li>
          <input class="toggle" type="checkbox">
          <span>Speak no evil</span>
          <img class="delete" src="https://cloud-n20l8ciby-hack-club-bot.vercel.app/90BtLxCD6.png">
        </li>
    </div>
  </div>
