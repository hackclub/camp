...
[class^="icon-"], [class*=" icon-"] {
  ...
  width: 12px;
  height: 12px;
  background-image: url("https://cloud-n20l8ciby-hack-club-bot.vercel.app/238xOQtCqY.png");
    ...
    <div class="todo">
      ...
      <ul id="todo-list">
        <li>
          ...
          <img class="delete" src="https://cloud-n20l8ciby-hack-club-bot.vercel.app/239BtLxCD6.png">
        </li>
        <li>
          <input class="toggle" type="checkbox">
          <span>Hear no evil</span>
          <img class="delete" src="https://cloud-n20l8ciby-hack-club-bot.vercel.app/240BtLxCD6.png">
        </li>
        <li>
          <input class="toggle" type="checkbox">
          <span>Speak no evil</span>
          <img class="delete" src="https://cloud-n20l8ciby-hack-club-bot.vercel.app/241BtLxCD6.png">
        </li>
      </ul>
    </div>
  </div>
